...
;(function ( $, window, document, undefined ) {
    ...
    Plugin.prototype._create = function () {
        ...
        this.element.append('<label for="password1">Password</label>');
        this.element.append('<input name="password1" id="password1" type="password" class="' + options.inputClass + '" "/>');
        ...
        this.element.append(
            ...
            <li data-criterion="letter" class="valid">At least <strong>one simple letter</li> \
